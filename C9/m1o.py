...
# Additional rated parameters
srated_val = 0.0287  # rated slip
Nrated_val = 1748.3  # rated speed in rev/min
wmrated_val = 2 * np.pi * Nrated_val / 60  # rated speed in rad/sec
Trated_val = Sb / wmrated_val  # rated torque
vasb = 220 / np.sqrt(3)  # phase rms voltage
iasb_val = 49.68  # rated rms phase current
...
print('Note: Simulink model s1o needs to be run separately')
...
print('- The Simulink model s1o.M contains the system equations')
