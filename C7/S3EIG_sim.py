"""
Synchronous Machine Simulation: Synchronous generator - eigenvalue analysis
Converted from Simulink model: s3eig.mdl
Generated automatically by sync_machine_converter.py

Model: Synchronous generator - eigenvalue analysis
